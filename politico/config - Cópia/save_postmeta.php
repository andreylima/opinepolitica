...
add_action( 'save_reclamacao', 'save_reclamacao_postmeta' );
add_action( 'publish_reclamacao', 'save_reclamacao_postmeta' );
...
function save_reclamacao_postmeta($post_id)
{
    ...
    if( isset( $_POST['local_reclamacao'] ) )
          update_post_meta( $post_id, 'local_reclamacao', $_POST['local_reclamacao']);

      if( isset( $_POST['situacao_reclamacao'] ) )
          update_post_meta( $post_id, 'situacao_reclamacao', $_POST['situacao_reclamacao']);

     if( isset( $_POST['bairro_reclamacao'] ) )
          update_post_meta( $post_id, 'bairro_reclamacao', $_POST['bairro_reclamacao']);
