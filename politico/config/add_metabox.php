...
function pol_add_custom_metaboxes()
{
    ...
    //Reclamação
    add_meta_box( 'local_reclamacao', 'Local da reclamacao', 'local_reclamacao_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'obs_bairro', 'Observação (Bairro)', 'obs_bairro_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'bairro_reclamacao', 'Bairro da reclamação', 'bairro_reclamacao_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'latitude', 'Latitude', 'latitude_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'longitude', 'Longitude', 'longitude_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'situacao_reclamacao', 'Situacao da reclamação', 'situacao_reclamacao_display_metabox', 'reclamacao', 'normal', 'high' );
    add_meta_box( 'Autor', 'Autor da Reclamação', 'autor_reclamacao_display_metabox', 'reclamacao', 'normal', 'high' );
}
...
function local_reclamacao_display_metabox($post, $box)
{
  $local_reclamacao = get_post_meta($post->ID, 'local_reclamacao', true);

?>
  <input type="text" name="local_reclamacao" id="local_reclamacao"
  value="<?php echo $local_reclamacao; ?>" />
<?php
...
function situacao_reclamacao_display_metabox($post, $box)
{
    $situacao_reclamacao = get_post_meta($post->ID, 'situacao_reclamacao', true);

?>
  <select name="situacao_reclamacao" id="situacao_reclamacao">
    <option value="nao_resolvida" <?php echo ($situacao_reclamacao == 'nao_resolvida') ? "selected" : ""; ?> >Não resolvida</option>
    <option value="resolvida" <?php echo ($situacao_reclamacao == 'resolvida') ? "selected" : ""; ?>>Resolvida</option>
  </select>
...
function bairro_reclamacao_display_metabox($post, $box)
{

    $bairro_reclamacao = get_post_meta($post->ID, 'bairro_reclamacao', true);
...
<?php
  ...
  foreach ($bairros as $bairro) { ?>
      <option value="<?php echo $bairro ?>" <?php echo ($bairro_reclamacao == $bairro) ? "selected" : ""; ?>><?php echo $bairro ?></option>
<?php
  }
?>
  </select>
...
function autor_reclamacao_display_metabox($post, $box)
{
   $autor = get_post_meta($post->ID, 'autor-email', true);
