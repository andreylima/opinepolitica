...
function add_markers(response, map)
{
  ...
  for (var i=0,len=response.length; i < len; i++) {
    ...
    var date = current.data.split('/'),
        ...
        +  '<h6 class="hc-info-address"><span class="icon map-marker"></span>&nbsp;'+current.local_denuncia+'</h6>'
        +  '<span class="hc-info-buttons">'
        +  '<a href="/denuncias/'+current.id+'" class="button tiny">+ Detalhes</a>'
        +  '</span>'
        + '<iframe id="link_video" style="width:400px;height:315px;background-color:black"  src="//www.youtube.com/embed/'+link_video+'" frameborder="0" allowfullscreen ALT="carregando video"></iframe>'
        +  '</div>';
