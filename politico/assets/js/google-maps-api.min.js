...
function add_markers(response, map)
{
  ...
  for (var i=0,len=response.length; i < len; i++) {
    ...
    marker = new google.maps.Marker({
      ...
      map: map,
      icon: templateDir+'/assets/img/pin_1.png',
    });
    ...
    var date = current.data.split('/'),
        ...
        + '<input type="text" name="situacao_denuncia" value="'+current.situacao_denuncia+'" id="situacao_denuncia" disabled>'
        + '<div class="flaticon-comments16 qtd-comments-denuncia">'+current.qtd_comments_denuncia+'</div>'
        +  '<a href="/denuncias/'+current.permalink+'" class="button-info-denuncia">+ Ver Denúncia</a></div>'
        +  '</div>';
